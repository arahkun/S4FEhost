...
var FishEgg = function () {
  function FishEgg(canvas) {
    _classCallCheck(this, FishEgg);
  ...
  FishEgg.prototype.createEyes = function createEyes() {
    this.createCircle(this.x + this.fish_egg.offset2, this.y + this.fish_egg.offset2, this.fish_egg.radius2 + 4, "rgba(60, 107, 138, 0.48)");
    this.createCircle(this.x + this.fish_egg.offset3, this.y + this.fish_egg.offset3, this.fish_egg.radius3 + 2, "rgba(255, 204, 67, 0.08)");
    this.createCircle(this.x + Math.random(this.progress / 350) * this.fish_egg.offset1, this.y + Math.random(this.progress / 350) * this.fish_egg.offset1, this.fish_egg.radius1, "rgba(4, 152, 90, 0.19)");
  };

  FishEgg.prototype.render = function render() {
    // Create inside parts
    this.createEyes();
    ...
    this.canvas.fill();
    this.canvas.strokeStyle = "rgba(148, 232, 146, 0.36)";
    this.canvas.stroke();
    this.canvas.closePath();
  };

  FishEgg.prototype.move = function move() {
...
var FishLarva = function () {
  function FishLarva(canvas, progress) {
    _classCallCheck(this, FishLarva);
  ...
  FishLarva.prototype.move = function move() {
...
var FishLarvaEgg = function () {
  function FishLarvaEgg(canvas, progress) {
    _classCallCheck(this, FishLarvaEgg);
  ...
  FishLarvaEgg.prototype.move = function move() {
    this.x += Math.cos(this.a) * this.s;
    this.y += Math.sin(this.a) * this.s;
    this.a += Math.random() * 0.8 - 0.4;
...
var Paramecium = function () {
  function Paramecium(canvas) {
    _classCallCheck(this, Paramecium);
  ...
  Paramecium.prototype.createOval = function createOval(x, y, w, h) {
    var kappa = .5522848,
        ox = w / 2 * kappa,
  ...
  Paramecium.prototype.render = function render() {
    // Create inside parts
    this.createOval(this.x, this.y, 12, 4);
  };

  Paramecium.prototype.move = function move() {
